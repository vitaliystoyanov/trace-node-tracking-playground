...
class DefaultLocalDataSource @Inject constructor(
    ...
    override fun observeAllNodesWithLatestTrace(): Flow<List<NodeWithLastTraceEntity>> =
        nodeDao.observeAllWithLastTrace()
    ...
    override suspend fun getAllNodesWithLatestTrace(): List<NodeWithLastTraceEntity> =
        nodeDao.getAllWithLastTrace()
