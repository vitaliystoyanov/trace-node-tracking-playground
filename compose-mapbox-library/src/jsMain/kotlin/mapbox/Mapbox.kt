...
open external class Map(options: MapboxOptions = definedExternally) : Evented {
    ...
    open fun queryRenderedFeatures(
        pointOrBox: Any /* JsTuple<Number, Number> | JsTuple<Any, Any> */ = definedExternally,
        options: `T$4` /* `T$4` & FilterOptions */ = definedExternally,
    ): Array<Feature>
    ...
    open fun setFilter(
        layer: String,
        filter: Array<Any>? = definedExternally,
    ...
    open fun queryTerrainElevation(
        lngLat: Any, /* JsTuple<Number, Number> */
    ...
    open fun setCenter(
        center: Any, /* JsTuple<Number, Number> */
    ...
    open fun panBy(
        offset: Any, /* JsTuple<Number, Number> */
        options: AnimationOptions? = definedExternally,
        eventData: EventData = definedExternally,
    ): Map /* this */
    ...
    ): Any /* Required<Pick<CameraOptions, String /* "zoom" | "bearing" */>> & `T$20` */

    open fun cameraForBounds(bounds: LngLatBounds): Any /* Required<Pick<CameraOptions, String /* "zoom" | "bearing" */>> & `T$20` */
    open fun cameraForBounds(
        bounds: Any, /* JsTuple<Any, Any> | JsTuple<Number, Number, Number, Number> | JsTuple<Number, Number> */
        options: CameraForBoundsOptions? = definedExternally,
    ): Any /* Required<Pick<CameraOptions, String /* "zoom" | "bearing" */>> & `T$20` */
...
open external class GeoJSONSource(options: GeoJSONSourceOptions = definedExternally) :
    ...
    open fun getClusterChildren(
        clusterId: Number,
        callback: (error: Any, features: Array<Feature>) -> Unit,
    ): GeoJSONSource /* this */
...
open external class MercatorCoordinate(x: Number, y: Number, z: Number = definedExternally) {
    ...
    companion object {
        fun fromLngLat(
            lngLatLike: Any, /* JsTuple<Number, Number> */
...
external interface LineLayout : Layout {
    ...
    operator fun set(
        key: String,
        value: dynamic, /* "butt" | "round" | "square" | JsTuple<String, Any> */
    )
}
...
external interface LinePaint {
    ...
    operator fun set(
        key: String,
        value: dynamic, /* Number? | StyleFunction? | JsTuple<String, Any> */
    )
...
external interface SymbolLayout : Layout {
    ...
    operator fun set(
        key: String,
        value: Array<String? /* "center" | "left" | "right" | "top" | "bottom" | "top-left" | "top-right" | "bottom-left" | "bottom-right" */>?,
    )
}
